...
export default function SectionNavigator({ items, sectionRefs, onSelect }) {
  ...
  return (
    <div style={{
      ...
      background:"rgba(4,8,26,0.6)", backdropFilter:"blur(14px)"
    }}>
      <p style={{
        fontFamily:"'DM Mono',monospace", fontSize:8.5,
        letterSpacing:"0.22em", textTransform:"uppercase",
        color:"rgba(255,255,255,0.22)", marginBottom:10, margin:"0 0 10px"
      }}>Navigate</p>
            ...
            >
              ...
              {!isAvailable && (
                <span style={{
                  ...
                  fontSize:8, color:"rgba(255,255,255,0.22)", letterSpacing:"0.1em"
                }}>soon</span>
              )}
            </motion.button>
          );

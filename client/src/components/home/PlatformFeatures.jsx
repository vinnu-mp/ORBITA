...
const FEATURES = [
  ...
  },
  {
    icon: "🌍",
    gradient:
      "linear-gradient(135deg,rgba(34,211,238,0.16),rgba(14,165,233,0.1))",
  ...
  },
  {
    icon: "🎮",
    gradient:
      "linear-gradient(135deg,rgba(52,211,153,0.14),rgba(16,185,129,0.09))",
  ...
  },
  {
    icon: "🔖",
    gradient:
      "linear-gradient(135deg,rgba(244,114,182,0.14),rgba(236,72,153,0.09))",
    ...
    >
      ...
      <span
        style={{
          ...
          background:
            "linear-gradient(135deg,#fff 0%,#93c5fd 60%,#818cf8 100%)",
    ...
    >
      ...
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg,transparent,rgba(34,211,238,0.25),rgba(129,140,248,0.25),transparent)",
        }}
      />
...
function BottomCTA() {
  ...
  const content = isLoggedIn
    ? {
        ...
        secondary: { label: "Open 3D Explorer", to: "/3d-explore" },
      }
    : {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background:
          "linear-gradient(135deg,rgba(34,211,238,0.06),rgba(129,140,248,0.06))",
